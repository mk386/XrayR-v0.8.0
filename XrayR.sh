...
#        return 0
#    fi
    bash <(curl -Ls https://raw.githubusercontent.com/jue0115/XrayR/main/install.sh) $version
    if [[ $? == 0 ]]; then
...
update_shell() {
    wget -O /usr/bin/XrayR -N --no-check-certificate https://raw.githubusercontent.com/jue0115/XrayR/main/XrayR.sh
    if [[ $? != 0 ]]; then
        echo ""
...
--- https://gitlab.com/XrayR-Backup/XrayR ---
  ${green}0.${plain} 修改配置
————————————————
